...
let load_cards = async function() {
    ...
    for (const el of document.querySelectorAll('.repo-card')) {
      ...
      el.innerHTML = `
      <div style="background: ${theme.background}; border-radius: 5px; padding: 20px; font-size: 18px; line-height: 1.5; color: #24292e;">
        ...
        <div style="font-size: 14px; margin-bottom: 16px; margin-top: 8px; color: ${theme.color};">${data.description}</div>
        <div style="font-size: 14px; color: ${theme.color}; display: flex;">
